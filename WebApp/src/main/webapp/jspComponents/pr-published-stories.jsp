...
<c:set var="stories" scope="request" value='${user.published_stories}'/>
<div id="published-stories">
    <h4 style="text-align:center;margin-bottom:20px;">Storie scritte</h4>
    <div class="row" id="container-stories">
        <c:choose>
            <c:when test="${stories.size()==0}">
                <h4 class="no-result">Ancora nessuna storia pubblicata!</h4>
            </c:when>
            <c:otherwise>
