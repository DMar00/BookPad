...
<html lang="it">
<head>
    <title>BookPad-${genre_found.name}</title>
    ...
    <div class="bp-single-page">
        <div class="container-fluid">
            <div class="page-box-fit">
                <div>
                    <h3 class="title">${genre_found.name}</h3>
                    <div class="genre-description">
                        <span>${genre_found.description}</span>
                    </div>
                    <div class="row" id="container-stories">
                        <c:choose>
                            <c:when test="${no_stories!=null}">
                                <h4 class="no-result">${no_stories}</h4>
                            </c:when>
                            <c:otherwise>

                                <c:set var="stories" scope="request" value='${genre_found.stories}'/>
