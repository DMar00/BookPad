                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                    ...
                    <ul class="navbar-nav mb-2 mb-lg-0 me-0">
                        <li class="nav-item d-flex align-items-center">
                            <a class="nav-link" href="${pageContext.request.contextPath}/Write">Scrivi</a>
                        </li>
                        <li class="nav-item d-flex align-items-center">
                            <a class="nav-link" href="${pageContext.request.contextPath}/Profile?username=${user_logged.username}">Profilo</a>
                        </li>
